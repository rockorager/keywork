...
pub const Widget = union(enum) {
    ...
    pub const TextInput = struct {
        ...
        placeholder_foreground: Color = default_input_theme.placeholder orelse colors.slate10,
...
pub const RenderNode = struct {
    ...
    scrollbar_track_color: Color = colors.slate3,
    scrollbar_color: Color = colors.slate8,
    autofocus: bool = false,
    skip_traversal: bool = false,
    can_request_focus: bool = true,
