...
const WayringXdgToplevelTag = @import("wayland/WayringXdgToplevelTag.zig");
const WayringXdgToplevelIcon = @import("wayland/WayringXdgToplevelIcon.zig");
...
pub fn main(init: std.process.Init) !void {
    ...
    var wayring_single_pixel_buffer: WayringSinglePixelBuffer = undefined;
    var wayring_single_pixel_buffer_initialized = false;
    var wayring_single_pixel_buffer_published = false;
    ...
    var wayring_xdg_dialog: WayringXdgDialog = undefined;
    var wayring_xdg_dialog_initialized = false;
    var wayring_xdg_dialog_published = false;
    ...
    var wayring_xdg_toplevel_tag: WayringXdgToplevelTag = undefined;
    var wayring_xdg_toplevel_tag_initialized = false;
    var wayring_xdg_toplevel_tag_published = false;
    var wayring_xdg_toplevel_icon: WayringXdgToplevelIcon = undefined;
    var wayring_xdg_toplevel_icon_initialized = false;
    var wayring_xdg_toplevel_icon_published = false;
    ...
    var wayring_pointer_constraints: WayringPointerConstraints = undefined;
    var wayring_pointer_constraints_initialized = false;
    var wayring_pointer_constraints_published = false;
    ...
    var wayring_zwlr_data_control: WayringZwlrDataControl = undefined;
    ...
    const WayringLifecycle = struct {
        ...
        xdg_dialog: ?*WayringXdgDialog,
        system_bell: ?*WayringSystemBell,
        xdg_toplevel_tag: ?*WayringXdgToplevelTag,
        xdg_toplevel_icon: ?*WayringXdgToplevelIcon,
    ...
    defer {
        ...
        if (wayring_zwlr_data_control_initialized) {
            if (wayring_zwlr_data_control_published) wayring_zwlr_data_control.unpublish();
            wayring_zwlr_data_control.deinit();
        }
        ...
        if (wayring_xdg_toplevel_tag_initialized) {
            if (wayring_xdg_toplevel_tag_published) wayring_xdg_toplevel_tag.unpublish();
            wayring_xdg_toplevel_tag.deinit();
        }
        if (wayring_xdg_toplevel_icon_initialized) {
            if (wayring_xdg_toplevel_icon_published) wayring_xdg_toplevel_icon.unpublish();
            wayring_xdg_toplevel_icon.deinit();
        }
        ...
        if (wayring_xdg_dialog_initialized) {
            if (wayring_xdg_dialog_published) wayring_xdg_dialog.unpublish();
            wayring_xdg_dialog.deinit();
        }
        ...
        if (wayring_content_type_initialized) {
            ...
            wayring_content_type.deinit();
        }
        if (wayring_single_pixel_buffer_initialized) {
            if (wayring_single_pixel_buffer_published) wayring_single_pixel_buffer.unpublish();
            wayring_single_pixel_buffer.deinit();
        }
        ...
        if (wayring_seat_adapter_initialized) {
            ...
            if (wayring_pointer_constraints_initialized) {
                if (wayring_pointer_constraints_published) wayring_pointer_constraints.unpublish();
                wayring_pointer_constraints.deinit();
            }
    ...
    if (wayland_server_mode != .libwayland) {
        ...
        wayring_pointer_constraints.init(init.gpa, &wayring_protocol_server.?, &wayring_seat_adapter, &wayring_compositor, server.neutralPointerConstraints(), server, Server.syncGeneratedPointerConstraints);
        wayring_pointer_constraints_initialized = true;
        ...
        wayring_zwlr_data_control.init(init.gpa, &wayring_protocol_server.?, &wayring_clients, &wayring_seat_adapter, server.neutralDataDevice(), std.os.linux.getuid());
        wayring_zwlr_data_control_initialized = true;
        ...
        wayring_data_control_fanout = .{ .ext = &wayring_data_control, .wlr = &wayring_zwlr_data_control };
        server.setDataControlObserver(.{
            .context = &wayring_data_control_fanout,
        ...
        wayring_xdg_dialog.init(init.gpa, &wayring_protocol_server.?, &wayring_xdg_shell, server.neutralXdgShell());
        wayring_xdg_dialog_initialized = true;
        wayring_system_bell.init(init.gpa, &wayring_protocol_server.?);
        wayring_system_bell_initialized = true;
        wayring_xdg_toplevel_tag.init(init.gpa, &wayring_protocol_server.?, &wayring_xdg_shell);
        wayring_xdg_toplevel_tag_initialized = true;
        wayring_xdg_toplevel_icon.init(init.gpa, &wayring_protocol_server.?, &wayring_xdg_shell, &wayring_compositor);
        wayring_xdg_toplevel_icon_initialized = true;
        wayring_viewporter.init(init.gpa, &wayring_protocol_server.?, &wayring_compositor);
        wayring_viewporter_initialized = true;
        wayring_single_pixel_buffer.init(init.gpa, &wayring_protocol_server.?, &wayring_compositor);
        ...
        if (wayring_presenting_headless) {
            ...
            try wayring_single_pixel_buffer.publish();
            ...
            try wayring_xdg_dialog.publish();
            wayring_xdg_dialog_published = true;
            try wayring_system_bell.publish();
            wayring_system_bell_published = true;
            try wayring_xdg_toplevel_tag.publish();
        ...
        wayring_lifecycle = .{
            ...
            .xdg_dialog = if (wayring_xdg_dialog_initialized) &wayring_xdg_dialog else null,
            .system_bell = if (wayring_system_bell_initialized) &wayring_system_bell else null,
            .xdg_toplevel_tag = if (wayring_xdg_toplevel_tag_initialized) &wayring_xdg_toplevel_tag else null,
            .xdg_toplevel_icon = if (wayring_xdg_toplevel_icon_initialized) &wayring_xdg_toplevel_icon else null,
            ...
            .pointer_constraints = if (wayring_pointer_constraints_initialized) &wayring_pointer_constraints else null,
...
test {
    ...
    _ = @import("wayland/WayringXdgDialog.zig");
    _ = @import("wayland/WayringXdgToplevelTag.zig");
    _ = @import("wayland/WayringXdgToplevelIcon.zig");
    ...
    _ = @import("wayland/WayringPointerConstraints.zig");
