...
test "lua default theme exposes opaque Radix component tokens" {
    ...
    const script =
        ...
        \\assert(theme.components.menu.shadow == theme.shadow[5])
        ...
        \\  assert(resolved.components.menu.border == nil)
        \\  assert(resolved.components.menu.shadow[2].blur == 60)
        \\  assert(resolved.components.menu.shadow[2].color == resolved.colors.black_a3 or resolved.components.menu.shadow[2].color == resolved.colors.black_a5)
