                ...
                return kw.center(
                    kw.sized({
                        ...
                        child = kw.container({
                            ...
                            padding = { all = 16 },
                            child = kw.text(
                                "Unicode line breaking keeps words together while allowing unusuallylongcontentwithoutbreaks to wrap safely."
                            ),
                        }),
                    })
                )
                        ...
                        child = kw.container({
                            ...
                            child = kw.column({
                                ...
                                children = {
                                    ...
                                    kw.text(
                                        line_breaking_sample,
                                        { font_size = 14, line_height = 20, line_break = line_break }
                                    ),
                                },
                            }),
                        }),
