...
pub fn build(b: *std.Build) void {
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "unstable/text-input/text-input-unstable-v3.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(b.path("protocols/wayland/upstream/input-method-unstable-v2.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/ext-data-control/ext-data-control-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/ext-workspace/ext-workspace-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(b.path("protocols/wayland/upstream/wlr-output-power-management-unstable-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/color-representation/color-representation-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/alpha-modifier/alpha-modifier-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/ext-background-effect/ext-background-effect-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/ext-idle-notify/ext-idle-notify-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/xdg-dialog/xdg-dialog-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/xdg-toplevel-icon/xdg-toplevel-icon-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/xdg-toplevel-tag/xdg-toplevel-tag-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "unstable/pointer-gestures/pointer-gestures-unstable-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "unstable/keyboard-shortcuts-inhibit/keyboard-shortcuts-inhibit-unstable-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "unstable/xdg-decoration/xdg-decoration-unstable-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "unstable/xdg-output/xdg-output-unstable-v1.xml"));
    generate_wayring_protocols.addArg("-i");
    ...
    generate_wayring_protocols.addArg("-i");
    generate_wayring_protocols.addFileArg(wayland.protocols.path(b, "staging/security-context/security-context-v1.xml"));
    generate_wayring_protocols.addArg("-i");
