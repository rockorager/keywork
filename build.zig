...
pub fn build(b: *std.Build) void {
    ...
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("unstable/xdg-output/xdg-output-unstable-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/ext-foreign-toplevel-list/ext-foreign-toplevel-list-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/ext-image-capture-source/ext-image-capture-source-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/ext-image-copy-capture/ext-image-copy-capture-v1.xml"));
    generate_xdg_protocol.addFileArg(b.path("protocols/wayland/upstream/wlr-foreign-toplevel-management-unstable-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/xdg-toplevel-drag/xdg-toplevel-drag-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/xdg-session-management/xdg-session-management-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/ext-transient-seat/ext-transient-seat-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/single-pixel-buffer/single-pixel-buffer-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/content-type/content-type-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/color-representation/color-representation-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/alpha-modifier/alpha-modifier-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/tearing-control/tearing-control-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/fifo/fifo-v1.xml"));
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("staging/commit-timing/commit-timing-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(b.dependency("wayland_protocols", .{}).path("unstable/pointer-constraints/pointer-constraints-unstable-v1.xml"));
    ...
    generate_xdg_protocol.addFileArg(b.path("protocols/wayland/upstream/wlr-output-power-management-unstable-v1.xml"));
    generate_xdg_protocol.addFileArg(b.path("protocols/wayland/upstream/wlr-gamma-control-unstable-v1.xml"));
