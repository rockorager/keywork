...
- Keep tests inline and ensure `keywork-runtime`, `keywork-lua`, and the Lua
  executable rooted at `src/main.zig` remain registered as separate roots in
  the repository test graph.
